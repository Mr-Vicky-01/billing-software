    ...
    <>
      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8 pb-24 sm:pb-28">
        ...
        <div className="text-center mb-8 sm:mb-12">
          {/* Icon Badge */}
          <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-modern-lg mb-4 sm:mb-6 hover-lift animate-scale-in">
